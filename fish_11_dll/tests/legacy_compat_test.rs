...
fn test_legacy_key_management() {
    ...
    legacy::test_utils::clear_test_legacy_keys();
...
fn test_legacy_encryption_format() {
    // Setup a test key
    legacy::test_utils::setup_test_legacy_key("#test", b"testkey12345678");
...
fn test_legacy_target_detection() {
    ...
    // Setup a key
    legacy::test_utils::setup_test_legacy_key("#legacy", b"testkey12345678");
