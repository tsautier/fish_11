...
dll_function_identifier!(FiSH10_DH1080_GenerateKeyPair, data, {
    ...
    log_debug!("FiSH10: Generating DH1080 key pair for '{}'", target);
    ...
    log_info!("FiSH10: Generated DH1080 key pair for '{}'", target);
...
dll_function_identifier!(FiSH10_DH1080_ComputeSecret, data, {
    ...
    log_debug!("FiSH10: Computing DH1080 shared secret for '{}'", target);
    ...
    let shared_secret = legacy::dh1080::compute_dh1080_shared_secret(private_key, other_public_key)?;

    log_info!("FiSH10: Computed DH1080 shared secret for '{}'", target);
...
dll_function_identifier!(FiSH10_DH1080_SetKey, data, {
    ...
    log_info!("FiSH10: Set DH1080 private key for '{}'", target);
...
mod tests {
    use super::*;
    use crate::legacy::test_utils::{setup_test_dh1080_key, clear_test_dh1080_keys};
