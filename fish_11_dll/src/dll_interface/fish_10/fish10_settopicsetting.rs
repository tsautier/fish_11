...
mod tests {
    ...
    fn test_set_topic_setting() {
        ...
        let result = test_set_topic_setting("testnet #testchan 1");
        assert!(result.is_ok());
        assert_eq!(result.unwrap(), "1");

        // Test setting topic encryption to disabled
        let result = test_set_topic_setting("testnet #testchan 0");
        assert!(result.is_ok());
        assert_eq!(result.unwrap(), "1");
    }
    ...
    fn test_set_topic_setting_invalid_input() {
        ...
        let result = test_set_topic_setting("invalid");
    ...
    fn test_set_topic_setting_invalid_enabled() {
        ...
        let result = test_set_topic_setting("testnet #testchan 2");
        assert!(result.is_err());
    }
}
