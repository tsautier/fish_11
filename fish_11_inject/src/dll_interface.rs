...
use fish_11_core::globals::{BUILD_DATE, BUILD_NUMBER, BUILD_TIME, BUILD_VERSION, MIRC_RETURN_DATA_COMMAND};
...
pub extern "system" fn FiSH11_InjectVersion(
    ...
    let version_info = format!(
        ...
        BUILD_VERSION, BUILD_NUMBER.as_str(), BUILD_DATE, BUILD_TIME
    );
