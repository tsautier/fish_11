...
fn get_fish_main_version(pkg_version: &str, build_date: &str, build_time: &str) -> String {
    format!(
        "{}compiled {} {} ***",
        format!("*** FiSH Inject {} *** by [GuY] *** fish_11_inject.dll ", pkg_version),
        build_date,
        build_time
    )
}
...
fn main() {
    ...
    // TODO : ensure vergen is working correctly all the time
    ...
    // Set the DLL's entry-point
    println!("cargo:rustc-cdylib-entry-point=DllMain");
}
